...
public class TransferTaxAssessmentPOReportController //extends ReportController
{
   ...
   String title = 'Transfer Tax Assessment';
   String reportPath = 'etracs/training/plugin/report/';
   String reportName = reportPath + 'TransferTaxPaymentOrder.jasper';
   def reportData;
...
//    }
    ...
    def report = [
        getReportName : { return reportPath + 'TransferTaxPaymentOrder.jasper'},
        getSubReports : { 
            return[
